...
private String etat="non traite" ;
    ...
    public Reclamation3(String sujet, String contenu, Date dateR, String etat, String email, String typerec) {
        this.id = id;
        this.sujet = sujet;
        this.contenu = contenu;
        this.dateR = dateR;
       ...
       public Reclamation3(int id,String sujet,String contenu,Date dateR,String etat,String email,String typerec) {
