...
public class Chambre2 {
    ...
    public Chambre2(Integer id, String style, String description, Integer numero, String nbpersonne, Float prix, String etat, String photo,String reserv) {
        setId(id);
        setStyle(style);
    ...
    public Chambre2(Integer id, String description, Integer numero, String nbpersonne, Float prix) {
        setId(id);
