...
public class InscriptionPController implements Initializable {
    ...
    @FXML
    private void signinP1(ActionEvent event) throws IOException, SQLException, AWTException {
        ...
        p.setRoles("a:1:{i:0;s:10:\"ROLE_PARENT\";}");
        ...
        Notifications n = new Notifications();
                n.displayTray("parent", "bien ajouté");
