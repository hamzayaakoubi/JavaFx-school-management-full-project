...
public class InscriptionETController implements Initializable {
    ...
    @FXML
    private void signinEt1(ActionEvent event) throws SQLException, IOException, AWTException {
        ...
        p.setRoles("a:1:{i:0;s:10:\"ROLE_ELEVE\";}");
        ...
        sp.creerUser(p);
            Notifications n = new Notifications();
                n.displayTray("etudiant", "bien ajouté");
