...
public class ChambreController implements Initializable {
    ...
    @FXML
    private void InsertVoiture(ActionEvent event) throws SQLException, AWTException {
        ...
        msg.setText("Chambre ajoutée");
         Notifications n = new Notifications();
                n.displayTray("Chambre", "bien ajouté");
    ...
    @FXML
    private void ModifVoiture(ActionEvent event) throws SQLException, AWTException {
        ...
        if (action.get() == ButtonType.OK) {
            ...
            msg.setText("Chambre Modifiée");
             Notifications n = new Notifications();
                n.displayTray("Chambre", "bien modifié");
        }
    ...
    private void SuppVoiture(ActionEvent event) throws SQLException, AWTException {
        ...
        if (action.get() == ButtonType.OK) {
            ...
            msg.setText("Chambre Supprimée");
             Notifications n = new Notifications();
                n.displayTray("Chambre", "bien supprimé");
        }
