...
//                                } else if (reclamation .getDateR().toUpperCase().indexOf(lowerCaseFilter) != -1 ) {
//					return true; // Filter matches first name
//				
//                                } else  
...
//        Parent parent =  FXMLLoader.load(getClass().getResource("/Fxml/FCReclamation.fxml"));
...
//            Logger.getLogger(Controller.StatController.class.getName()).log(Level.SEVERE, null, ex);
//        }
//
//    }
//    
...
//
//         try {
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Fxml/Reclamation2.fxml"));
//            Parent root = loader.load();
//            
...
//
//        mainpane.getChildren().clear();
//        Parent parent =  FXMLLoader.load(getClass().getResource("/Fxml/BTypeReclamation.fxml"));
//        mainpane.getChildren().add(parent);
//        mainpane.toFront();  
//            
//            
...
//
//    @FXML
//    private void afficherFAQ(ActionEvent event) throws IOException {
//        
//        
//          mainpane.getChildren().clear();
