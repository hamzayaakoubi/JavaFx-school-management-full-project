...
public class Evenement {
	...
	public Evenement(int idEvenement, int idClub, String designation, int nbPlaces, String etat, Date dateDebut,
			Date dateFin, String description, String typeEvenement) {
		this.idEvenement = idEvenement;
		this.idClub = idClub;
		this.designation = designation;
		this.nbPlaces = nbPlaces;
	...
	public Evenement(Integer idClub, String designation, int nbPlaces, String etat, Date dateDebut, Date dateFin,
			String description, String typeEvenement) {
		this.idClub = idClub;
		this.designation = designation;
		this.nbPlaces = nbPlaces;
		this.etat = etat;
