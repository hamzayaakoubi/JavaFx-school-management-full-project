...
public class User {
	...
	public User(int id, String username, String email, String password, String roles, String nom, String prenom,
			int num_tel, String photo, String cin, String sexe, String status, String date_naissance, String demande) {
		this.id = id;
	...
	public User(int id, String username, String password, String email, String nom, String prenom, String cin,
			String sexe, String role) {
		throw new UnsupportedOperationException("Not supported yet."); // To change body of generated methods, choose
																		// Tools | Templates.
	}
